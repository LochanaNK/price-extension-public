...
**⚠️ Note:** This is the client-side repository for the Price Comparator project.
...
Since this is a custom developer extension, you need to install it manually (it takes about 30 seconds).
Step 1: Download
